...
void gmmreg_cpd::start_registration(vnl_vector<double>& params, int n_max_func_evals) {
  int EMiter, iter = 0;
  double Eu, E_old;
  double E = 1;
  ...
  while ((iter < n_max_func_evals) && (ntol > tol)) {
    std::cout << "iter=" << iter << "\n";
...
void gmmreg_cpd::set_init_params() {
